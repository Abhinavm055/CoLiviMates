...
import { Search, Filter, X, Home, MapPin, Loader2, AlertCircle } from 'lucide-react';
...
export default function Listings() {
  ...
  useEffect(() => {
    const fetchListings = async () => {
      ...
      try {
        const params = {
          ...
          sharingType: sharingType === 'all' ? undefined : sharingType,
          maxRent: maxRent,
          limit: 100 // Fetch a substantial list to allow for instantaneous local search typing
        };
        const data = await listingsAPI.getAll(params);
        console.log('Listings API response received by Listings.jsx:', data);
        
        // Map backend snake_case properties to frontend camelCase expected by components
        const mapped = data.listings.map(l => ({
          ...l,
          sharingType: l.sharing_type,
          ownerName: l.owner_name,
          availableFrom: l.available_from ? new Date(l.available_from) : null,
    ...
    fetchListings();
  }, [selectedCity, sharingType, maxRent]);
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-24 gap-4">
            ...
            <p className="text-muted-foreground text-sm font-medium">Fetching best stays for you...</p>
          </div>
          ...
          <div className="text-center py-16 bg-card rounded-2xl border border-border/50">
            ...
            <p className="text-muted-foreground mb-6 max-w-md mx-auto">
              Don't worry! Try increasing your budget or checking other cities.
            </p>
