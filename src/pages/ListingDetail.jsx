...
import { ArrowLeft, MapPin, Calendar, User, CheckCircle, Wifi, Wind, Car, Home, Users, Send } from 'lucide-react';
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-foreground">{listing.availableFrom.toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
