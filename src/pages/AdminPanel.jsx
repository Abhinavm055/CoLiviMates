...
import { Users, Home, MessageSquare, Shield, CheckCircle, XCircle, Clock, Eye, UserCheck, AlertTriangle } from 'lucide-react';
                  ...
                  <CardContent className="p-4 md:p-6">
                    <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                      ...
                      <div className="flex gap-2">
                        <Button variant="outline" size="sm" className="gap-1"><Eye className="w-4 h-4" />Review</Button>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                      ...
                      <div className="flex gap-2">
                        ...
                        {listing.status === 'approved' && !listing.verified && (
                          <Button size="sm" className="gap-1"><CheckCircle className="w-4 h-4" />Verify</Button>
                        )}
                      </div>
                    </div>
                  </CardContent>
